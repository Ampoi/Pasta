<template>
  <div
    class="basis-48 border-r-[1px] border-zinc-700 flex flex-col gap-4 text-zinc-500 px-2 pb-8 pt-[46px]">
    <div class="flex flex-col">
      ...
      <button
        ...
        <p class="text-white grow whitespace-nowrap overflow-hidden text-ellipsis text-left text-sm">
          {{ id }}
        </p>
      </button>
    </div>
